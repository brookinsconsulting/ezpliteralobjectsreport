<?php
/**
 * File containing the literalreport module configuration file, module.php
 *
...
// Define module name
$Module = array('name' => 'Literal Report');
...
$ViewList['report'] = array( 'script' => 'report.php',
                             ...
                             'default_navigation_part' => 'ezliteralreportnavigationpart',
